    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
          ...
          {/* Required Columns */}
          <div className="mb-4">
            <h5 className="text-sm font-bold text-red-700 mb-2">🔴 Required Columns (Must Have):</h5>
            <div className="bg-white border rounded-lg p-3 text-xs font-mono overflow-x-auto">
              <div className="text-gray-800 whitespace-pre">
App.No,Name,BranchName,TaskName{'\n'}
BL001,John Doe,Mumbai Branch,Sanctioned{'\n'}
BL002,Jane Smith,Delhi Branch,Documentation Complete{'\n'}
BL003,Bob Wilson,Pune Branch,Final Approval
              </div>
            </div>
          </div>
          ...
          {/* Optional Columns */}
          <div className="mb-4">
            <h5 className="text-sm font-bold text-blue-700 mb-2">🔵 Optional Columns (Can Include):</h5>
            <div className="bg-white border rounded-lg p-3 text-xs font-mono overflow-x-auto">
              <div className="text-gray-800 whitespace-pre text-blue-600">
AppDate,LoanNo,Amount,Email,Login,Asset Type,Sanction Amount{'\n'}
2024-01-15,LN001,500000,john@email.com,EMP001,Home Loan,450000{'\n'}
2024-01-16,LN002,300000,jane@email.com,EMP002,Personal Loan,280000
              </div>
            </div>
          </div>

          {/* Sanction Status Examples */}
          <div className="mb-4">
            <h5 className="text-sm font-bold text-green-700 mb-2">✅ Sanctioned Status Examples:</h5>
            <div className="text-xs text-green-600 space-y-1">
              <div>• Sanctioned • Approved • Disbursed • Documentation</div>
              <div>• Final Approval • Completed • Loan Sanctioned</div>
              <div>• Documentation Complete • Ready for Disbursement</div>
            </div>
          </div>

          <div className="mt-4 text-xs text-gray-600 space-y-2">
            <div className="bg-yellow-50 border border-yellow-200 rounded p-2">
              <strong>📌 Important:</strong> Only rows with sanctioned status in TaskName will be imported. 
              Other statuses (pending, under review, rejected) will be automatically skipped.
            </div>
            <div>
              <a 
                href="/sample-applications.csv" 
                download="sample-applications.csv"
                className="inline-flex items-center space-x-1 text-cyan-600 hover:text-cyan-800 font-medium"
              >
