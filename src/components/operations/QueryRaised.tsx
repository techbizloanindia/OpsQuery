...
export default function QueryRaised() {
  ...
  const availablePeople = [
    'Punit Chadha', 'Abhishek Mishra', 'Aarti Pujara',
    'Mohan Keswani', 'Vikram Diwan'
  ];
  ...
  const actionMutation = useMutation({
    ...
    onSuccess: (data, variables) => {
      ...
      switch (variables.action) {
        case 'approve':
          message = 'Query approved successfully! Query moved to resolved section. ✅';
          break;
        case 'deferral':
          message = `Query deferred to ${variables.person} successfully! Query moved to resolved section. 📋`;
          break;
        case 'otc':
          message = `OTC assigned to ${variables.person} successfully! Query moved to resolved section. 🏢`;
          break;
      }
