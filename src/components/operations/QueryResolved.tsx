...
// Fetch all queries (both pending and resolved) for processing
const fetchAllQueries = async (): Promise<Query[]> => {
  ...
  // Return all queries - both pending and resolved
  return result.data || [];
};
...
export default function QueryResolved() {
  ...
  const { data: queryHistory, isLoading: historyLoading } = useQuery({
    queryKey: ['queryHistory', selectedQuery?.id],
  ...
  // Extract individual queries for display (both pending and resolved)
    ...
    <div className="bg-slate-50 min-h-screen">
      <div className="container mx-auto p-4 md:p-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-black font-['Inter',sans-serif]">Query Processing</h1>
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4">
            <h2 className="text-xl font-semibold">All Individual Queries (Pending & Resolved)</h2>
          </div>
                    ...
                    <div key={query.id} className="bg-white p-4 rounded-lg border border-l-4 border-l-green-500 shadow-sm">
                      ...
                      <div className="text-xs text-black flex items-center gap-4">
                        <span>
                          ...
                          <span className="ml-1">{query.resolvedBy || selectedQuery.resolvedBy || 'Operations Team'}</span>
                        </span>
                        <span>
