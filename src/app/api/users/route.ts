...
export async function POST(request: NextRequest) {
  try {
    ...
    const { employeeId, fullName, email, phone, password, role, branch, branchCode, department } = body;
    
    console.log('📋 User creation request:', { employeeId, fullName, email, role, branch, branchCode, department });
